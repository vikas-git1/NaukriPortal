...
import "../../styles/JDReviewCard.css";
const JDReviewCard = () => {
  return (
    <div className="SecondCardParentContainer">
      <div className="SecondcardMainContainer">
        ...
        <div className="mainTxtContainer">
          <b className="mainFirstText">
            Senior Relationship Manager for 8 months in New De...
          </b>
          <p>
            <span className="Anonymous">Anonymous </span>
            <span className="seprator">|</span> 12 Mar 2025
          </p>
        </div>
        ...
        <div className="LikesContainer">
          <b>Likes</b>
          <p>
            Nothing !!! it's a dead company, only politics and completely
            disorganised. Undue work pressure no cooperation. Worse than a
        ...
        <div className="SecondCardFotterContainer">
          <p>Powered by </p>
          <img src="images/ambitionBoxImg.png" alt="box" className="box" />
